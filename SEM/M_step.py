...
def train_model_node_classification_withembeddings(args, Etrainer, gt_weight, Mtrainer, data, logger, save_model_folder, patience, train,
...
def sem_m_step(Etrainer, Mtrainer, gt_weight, data, args, logger, src_node_embeddings, dst_node_embeddings, pseudo_labels,iter_num, pseudo_labels_store):
