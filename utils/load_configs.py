...
def get_node_classification_args():
    ...
    parser.add_argument('--prefix',type=str,help='prefix of work')
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='wikipedia', choices=['arxiv','oag','wikipedia', 'mooc','bot', 'bot22','reddit','rt_wiki','dsub','dgraph','yelp'])
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
...
def get_node_classification_em_args():
    ...
    parser.add_argument('--method', type=str, default='PTCL-2D', choices=['PTCL', 'SEM', 'NPL' 'PTCL-2D'],help='Which method to be used to train')
