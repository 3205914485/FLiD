def get_node_classification_npl_args():
    """
    get the args for the node classification task
    :return:
    """
    # arguments
    parser = argparse.ArgumentParser('Interface for the node classification task With The NPL algorithm')

    # Configuration of the experiment
    parser.add_argument('--prefix',type=str, default='test', help='prefix of work')
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='oag', choices=['oag','wikipedia', 'reddit', 'dsub'])
