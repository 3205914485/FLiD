    ...
    with torch.no_grad():
        ...
        for batch_idx, evaluate_data_indices in enumerate(evaluate_idx_data_loader_tqdm):
            ...
            if dataset in double_way_dataset:
                predicts = model(x=torch.cat([batch_src_node_embeddings,batch_dst_node_embeddings],dim=0))
        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx, train_data_indices in enumerate(train_idx_data_loader_tqdm):
                ...
                #  0 loss for this batch
                    train_idx_data_loader_tqdm.set_description(f'Epoch: {epoch + 1}, train for the {batch_idx + 1}-th batch, no valid predictions')
